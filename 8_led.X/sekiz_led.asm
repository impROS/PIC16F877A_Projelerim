...
START  	clrf 	PORTB	; PORTB ç?k??lar? 0  yap?ld? 
    ...
    clrf   	TRISB         	; PORTB ç?k?? yap?ld?
    bcf  	STATUS,RP0           	; bank0
j1      	movlw   	b'00000000'         	; w registerine ff yükle (11 1 1 1 1)
    movwf  	PORTB         	; PORTB' ye ba?l? LED ler yand?
    call    	zaman         	; zaman program?na ca??r
    movlw   	b'11111111'           	; w registerine 00 yükle (0 0 0 0 0 0 0 0)
    movwf   	PORTB         	; PORTB' ye ba?l? LED ler söndü
